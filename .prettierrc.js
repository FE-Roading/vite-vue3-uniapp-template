module.exports = {
  ...
  trailingComma: "none", // 代码末尾不需要逗号，有三个可选值"<none|es5|all>"
  arrowParens: "avoid", // 单个参数的箭头函数不加括号，avoid是允许x => x， always为不允许
  bracketSpacing: true, // 对象大括号内两边是否加空格 { a:0 }

  // endOfLine: 'auto',         // 文件换行格式 LF/CRLF， <lf|crlf|cr|auto>，more为lf
